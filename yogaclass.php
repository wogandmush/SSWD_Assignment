...
?>
    ...
    <div class="jumbotron text-center">
      ...
      <div class="view overlay my-4">
        ...
        <img src="https://www.prestigegym.gr/wp-content/uploads/2017/10/yoga-header.jpg" height="600" width="1280">
        <a href="#"></a>
      </div>

    <div class="container">
     <h1 class="h1-responsive font-weight-bold text-center my-5">Yoga</h1>
