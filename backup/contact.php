...
<!--tested it and it doesn't seem to be working sending email at the moment :(, says email sent but no email-->
...
<section class="mb-4">
    ...
    <p class="text-center w-responsive mx-auto mb-5">Do you have any questions? Please do not hesitate to contact us directly.</p>
        ...
        <div class="container">
            ...
            <!-- when submitted this file redirect ro mail.php which will send email -->
