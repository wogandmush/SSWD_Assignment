...
?>
    ...
    <div class="jumbotron text-center">
      ...
      <div class="view overlay my-4">
        ...
        <img src="https://www.lesmills.com.au/sites/default/files/styles/web_header/public/2017-02/bodyattack_class1.jpg?itok=vYptkEKg" height="600" width="1280">
        <a href="#"></a>
      </div>

     <div class="container">
     <h1 class="h1-responsive font-weight-bold text-center my-5">Strength</h1>
